...
namespace FasePractica.WebApp.Controllers
{
    public class NotasController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("NotaId,Calificacion,Aprueba")] Nota nota)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("NotaId,Calificacion,Aprueba")] Nota nota)
        {
            if (id != nota.NotaId)
            {
                return NotFound();
