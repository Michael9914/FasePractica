...
namespace FasePractica.WebApp.Controllers
{
    public class TutoresController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("TutorId,CodigoIgnug,PersonaId,Nombres,Apellidos,Cedula,CorreoInstitucional,CorreoPersonal,Telefono")] Tutor tutor)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("TutorId,CodigoIgnug,PersonaId,Nombres,Apellidos,Cedula,CorreoInstitucional,CorreoPersonal,Telefono")] Tutor tutor)
        {
