...
namespace FasePractica.WebApp.Controllers
{
    public class ProyectosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ProyectoId,Descripcion,Tecnologia")] Proyecto proyecto)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ProyectoId,Descripcion,Tecnologia")] Proyecto proyecto)
        {
